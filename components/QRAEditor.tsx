...
import { 
  ...
  BarChart2, AlertCircle, TrendingUp, BookOpen, Grid, Activity, FileText
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans">
      ...
      <div className="flex-grow p-6 grid grid-cols-1 lg:grid-cols-12 gap-6 overflow-auto bg-grid-pattern">
        ...
        <div className="lg:col-span-7 flex flex-col">
            ...
            {activeTab === 'fn' ? (
               <div className="bg-white rounded-xl border border-slate-200 p-6 flex flex-col items-center justify-center shadow-lg animate-fade-in" ref={chartRef}>
               ...
               <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-lg animate-fade-in" ref={chartRef}>
